  ...
  <div>
    <div className="RowFlex ColorAbout">
      ...
      <div className="TextHistoryDescription">
        Около полугода назад мы задумались, как можно помочь людям найти организацию для решения каких либо проблем.
        При этом расчитывать не на красивые, и к сожелению иногда лживые, слова рекламщиков. И мы решили сделать сервис
        для поиска организаций любого маштаба и предоставить им площадку для соревнования. На нашем ресурсе всё решается
        отзывами клиентов, чем лучше вы его обслужили, тем лучше отзыв, чем лучше отзыв, тем выше вы в поисковом запросе
        , тем вероятнее то, что вашу организацию выберет большее количество людей.
      </div>
    </div>
